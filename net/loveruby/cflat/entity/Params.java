...
public class Params extends ParamSlots<_Parameter>
        implements net.loveruby.cflat.ast.Dumpable {
    public Params(Location loc, List<_Parameter> paramDescs) {
        super(loc, paramDescs, false);
    }

    public List<_Parameter> parameters() {
        return paramDescriptors;
    }

    public ParamTypeRefs parametersTypeRef() {
        List<TypeRef> typerefs = new ArrayList<TypeRef>();
        for (_Parameter param : paramDescriptors) {
